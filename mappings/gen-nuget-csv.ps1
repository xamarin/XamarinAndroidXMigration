...
$androidxConfigUrl = "https://raw.githubusercontent.com/xamarin/AndroidSupportComponents/AndroidX/config.json"
...
$androidxJson = (Invoke-WebRequest $androidxConfigUrl | ConvertFrom-Json)[0]
